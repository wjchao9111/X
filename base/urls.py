...
urlpatterns = patterns(
    ...
    url(r'^user-insert/$', common_save, {'model_type': 'base.models.User', 'persist_field': ['pwd']}),
    url(r'^user-update/$', common_save, {'model_type': 'base.models.User', 'persist_field': ['pwd']}),
    ...
    url(r'^role-insert/$', common_save, {'model_type': 'base.models.Role', 'persist_field': ['pwd']}),
    url(r'^role-update/$', common_save, {'model_type': 'base.models.Role', 'persist_field': ['pwd']}),
    ...
    url(r'^perm-insert/$', common_save, {'model_type': 'base.models.Permission', 'persist_field': ['pwd']}),
    url(r'^perm-update/$', common_save, {'model_type': 'base.models.Permission', 'persist_field': ['pwd']}),
    ...
    url(r'^dept-insert/$', common_save, {'model_type': 'base.models.Dept', 'persist_field': ['pwd']}),
    url(r'^dept-update/$', common_save, {'model_type': 'base.models.Dept', 'persist_field': ['pwd']}),
