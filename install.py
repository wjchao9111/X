...
cmd_list = [
    ...
    [['all', 'install', ], 'cp /opt/sms-impl/start_file.py /opt/sms-impl/cmpp2file'],
    ...
    [['all', 'install', ], 'cp conf/cmpp2file /etc/init.d/cmpp2file'],
    ...
    [['all', 'install', ], 'dos2unix /opt/sms-impl/cmpp2file'],
    ...
    [['all', 'install', ], 'dos2unix /etc/init.d/cmpp2file'],
